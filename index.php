    ...
    <header class="header">
         <div class="primary-navbar cmn-nav">
                     ...
                     <nav class="navbar p-0">
                        <div class="navbar__logo">
                           <a href="index.html" aria-label="go to home">
                              <img src="assets/images/logo-light.png" alt="Image" width="300px">
                           </a>
                        </div>
                        <div class="navbar__menu">
                           <ul>
                              <li class="navbar__item navbar__item--has-children nav-fade" style="animation-delay: 0s;">
                               ...
                               <li class="navbar__item navbar__item--has-children nav-fade" style="animation-delay: 0s;">
                                 <a href="about-us.html" aria-label="dropdown menu" class="navbar__dropdown-label">about</a>
                              </li>
                              <li class="navbar__item navbar__item--has-children nav-fade" style="animation-delay: 0.4s;">
                              ...
                              <li class="navbar__item navbar__item--has-children nav-fade" style="animation-delay: 0.6s;">
                              ...
                              <li class="navbar__item navbar__item--has-children nav-fade" style="animation-delay: 0.8s;">
                                 ...
                                 <!-- <ul class="navbar__sub-menu">
                                    ...
                                    <li class="navbar__item navbar__item--has-children">
                                       <a href="javascript:void(0)" aria-label="dropdown menu" class="navbar__dropdown-label navbar__dropdown-label-sub">Team</a>
                              ...
                              <li class="navbar__item navbar__item--has-children nav-fade" style="animation-delay: 1s;">
            ...
            <div class="mobile-menu">
               <nav class="mobile-menu__wrapper nav-fade-active">
                  <div class="mobile-menu__header nav-fade" style="animation-delay: 1.2s;">
                     <div class="logo">
                        <a href="index.html">
                  ...
                  <div class="mobile-menu__list">
                           <ul>
                              <li class="navbar__item navbar__item--has-children nav-fade" style="animation-delay: 1.4s;">
                                 <a href="javascript:void(0)" aria-label="dropdown menu" class="navbar__dropdown-label">Home</a>
                                 <ul class="navbar__sub-menu navbar__sub-menu--lg">
                                    <li>
                                       <a href="index.html">Creative Agency</a>
                              ...
                              <li class="navbar__item nav-fade" style="animation-delay: 1.6s;">
                                 <a href="about-us.html">About Us</a>
                              </li>
                              <li class="navbar__item navbar__item--has-children nav-fade" style="animation-delay: 1.8s;">
                                 <a href="javascript:void(0)" aria-label="dropdown menu" class="navbar__dropdown-label">Services</a>
                                 <ul class="navbar__sub-menu">
                                    <li>
                                       <a href="our-services.html">Our Services</a>
                              ...
                              <li class="navbar__item navbar__item--has-children nav-fade" style="animation-delay: 2s;">
                                 <a href="javascript:void(0)" aria-label="dropdown menu" class="navbar__dropdown-label">Projects</a>
                                 <ul class="navbar__sub-menu">
                                    <li>
                                       <a href="our-projects.html">Our Projects</a>
                              ...
                              <li class="navbar__item navbar__item--has-children nav-fade" style="animation-delay: 2.2s;">
                                 <a href="javascript:void(0)" aria-label="dropdown menu" class="navbar__dropdown-label">Pages</a>
                                 <ul class="navbar__sub-menu">
                                    <li>
                                       <a href="faq.html">FAQ</a>
                              ...
                              <li class="navbar__item navbar__item--has-children nav-fade" style="animation-delay: 2.4s;">
                                 <a href="javascript:void(0)" aria-label="dropdown menu" class="navbar__dropdown-label">Blog</a>
                                 <ul class="navbar__sub-menu">
                                    <li>
                                       <a href="blog.html">Blog</a>
                  ...
                  <div class="mobile-menu__options d-flex d-sm-none justify-content-center nav-fade" style="animation-delay: 2.6s;">
                              <a href="contact-us.html" class="btn btn--secondary">Let's Talk</a>
                           </div>
                  <div class="mobile-menu__social social nav-fade" style="animation-delay: 2.8s;">
                     ...
                     <ul>
                        <li class="navbar__item navbar__item--has-children nav-fade">
                           <a href="javascript:void(0)" aria-label="dropdown menu"
                              class="navbar__dropdown-label">Home</a>
                           <ul class="navbar__sub-menu">
                              <li>
                                 <a href="index.html">Creative Agency</a>
                              </li>
         ...
         <div id="smooth-content">
            ...
            <main>
               ...
               <section class="banner">
                  ...
                  <img src="https://images.pexels.com/photos/313690/pexels-photo-313690.jpeg" alt="Image"
               ...
               <section class="section agency">
                  <div class="container">
                     <div class="row gaper align-items-center">
                        <div class="col-12 col-lg-6 f1-cr-agency">
                           <div class="agency__thumb">
                              <img src="https://images.pexels.com/photos/6476256/pexels-photo-6476256.jpeg" alt="Image"
                                 class="thumb-one fade-left"
                                 style="translate: none; rotate: none; scale: none; transform: translate(0px, 0px); opacity: 1;">
                              <img src="https://images.pexels.com/photos/6476248/pexels-photo-6476248.jpeg" alt="Image"
                                 class="thumb-two fade-right"
                                 style="translate: none; rotate: none; scale: none; transform: translate(0px, 0px); opacity: 1;">
                           </div>
                        </div>
                        <div class="col-12 col-lg-6 f2-cr-agency">
                           <div class="agency__content section__content">
                              ...
                              <div class="paragraph">
                                 <p>
                                    ...
                                    generation on the runway heading towards a streamlined
                              ...
                              <div class="skill-wrap">
                                 <div class="skill-bar-single">
                                    ...
                                    <div class="skill-bar-wrapper" data-percent="75%">
                                       <div class="skill-bar">
                                          <div class="skill-bar-percent" style="width: 75%;">
                                 ...
                                 <div class="skill-bar-single">
                                    ...
                                    <div class="skill-bar-wrapper" data-percent="90%">
                                       <div class="skill-bar">
                                          <div class="skill-bar-percent" style="width: 90%;">
               ...
               <section class="section portfolio pb-0 fade-wrapper position-relative">
                  ...
                  <div class="container-fluid" style="max-width: 1440px; margin: 0px auto;">
                     <div class="row gaper">

                        <!-- Portfolio Card 1 - Nike India -->
                        <div class="col-12 col-sm-6 col-xl-3 creators_card-col">
                           <div class="creators_card">

                              <!-- Background Image -->
                              <div class="creators_image-wrapper">
                                 <img src="https://ik.imagekit.io/kaveeshkapoor/acollabmedia/promotion%20(4).png?updatedAt=1762243504313p"
                                    alt="Nike India" class="creators_image">
                                 <!-- Gradient Overlay at Bottom -->
                                 <div class="creators_gradient-overlay"></div>
                              </div>

                              <!-- Content Section with Dark Background -->
                              <div class="creators_content">

                                 <!-- Brand Name & Description -->
                                 <div class="creators_header">
                                    <h3 class="creators_title">Nike India</h3>
                                 </div>

                                 <!-- Metrics Row -->
                                 <div class="creators_metrics">
                                    <div class="creators_metric-box creators_metric-flex">
                                       <div class="creators_metric-value">
                                          <span class="creators_icon-star">★</span>
                                          <span class="creators_number">2.5M</span>
                                       </div>
                                       <div class="creators_metric-label">Impressions</div>
                                    </div>
                                    <div class="creators_metric-box">
                                       <div class="creators_metric-value-text">156 Posts</div>
                                       <div class="creators_metric-label">3 Night Stay</div>
                                    </div>
                                 </div>

                                 <!-- Social Icons & Button -->
                                 <div class="creators_footer">
                                    <div class="creators_social-icons">
                                       <div class="creators_social-icon">
                                    ...
                                    <a href="portfolio.html" class="creators_btn">
                                       View Details
                                    </a>
                                 </div>
                              </div>
                        ...
                        <!-- Portfolio Card 2 - Coca-Cola -->
                        <div class="col-12 col-sm-6 col-xl-3 creators_card-col">
                           <div class="creators_card">

                              <div class="creators_image-wrapper">
                                 <img src="https://ik.imagekit.io/kaveeshkapoor/acollabmedia/promotion%20(8).png?updatedAt=1762243504262"
                                    alt="Coca-Cola" class="creators_image">
                                 <div class="creators_gradient-overlay"></div>
                              </div>

                              <div class="creators_content">
                                 <div class="creators_brand-logo">
                                    <img
                                       src="https://ik.imagekit.io/kaveeshkapoor/acollabmedia/Untitled%20design%20(7).png?updatedAt=1762247676577"
                                       class="creators_logo-img">
                                 </div>

                                 <div class="creators_header">
                                    <h3 class="creators_title">Coca-Cola</h3>
                                 </div>
                                 ...
                                 <div class="creators_metrics">
                                    <div class="creators_metric-box creators_metric-flex">
                                       <div class="creators_metric-value">
                                          <span class="creators_icon-star">★</span>
                                          <span class="creators_number">3.8M</span>
                                       </div>
                                       <div class="creators_metric-label">Impressions</div>
                                    </div>
                                    <div class="creators_metric-box">
                                       <div class="creators_metric-value-text">243 Posts</div>
                                       <div class="creators_metric-label">4 Night Stay</div>
                                    </div>
                                 </div>
                        ...
                        <!-- Portfolio Card 3 - Zara Fashion -->
                        <div class="col-12 col-sm-6 col-xl-3 creators_card-col">
                           <div class="creators_card">

                              <div class="creators_image-wrapper">
                                 <img src="https://ik.imagekit.io/kaveeshkapoor/acollabmedia/promotion%20(3).png?updatedAt=1762243504185"
                                    alt="Zara Fashion" class="creators_image">
                                 <div class="creators_gradient-overlay"></div>
                              </div>
                              ...
                              <div class="creators_content">
                                 ...
                                 <div class="creators_header">
                                    <h3 class="creators_title">Zara Fashion</h3>
                                 </div>
                                 ...
                                 <div class="creators_metrics">
                                    <div class="creators_metric-box creators_metric-flex">
                                       <div class="creators_metric-value">
                                          <span class="creators_icon-star">★</span>
                                          <span class="creators_number">1.9M</span>
                                       </div>
                                       <div class="creators_metric-label">Impressions</div>
                                    </div>
                                    <div class="creators_metric-box">
                                       <div class="creators_metric-value-text">189 Posts</div>
                                       <div class="creators_metric-label">Guest Favorite</div>
                                    </div>
                                 </div>
                        ...
                        <!-- Portfolio Card 4 - Apple -->
                        <div class="col-12 col-sm-6 col-xl-3 creators_card-col">
                           <div class="creators_card">

                              <div class="creators_image-wrapper">
                                 <img src="https://ik.imagekit.io/kaveeshkapoor/acollabmedia/promotion%20(1).png?updatedAt=1762243503982"
                                    alt="Apple" class="creators_image">
                                 <div class="creators_gradient-overlay"></div>
                              </div>
                              ...
                              <div class="creators_content">
                                 ...
                                 <div class="creators_header">
                                    <h3 class="creators_title">Apple</h3>
                                 </div>
                                 ...
                                 <div class="creators_metrics">
                                    <div class="creators_metric-box creators_metric-flex">
                                       <div class="creators_metric-value">
                                          <span class="creators_icon-star">★</span>
                                          <span class="creators_number">5.2M</span>
                                       </div>
                                       <div class="creators_metric-label">Impressions</div>
                                    </div>
                                    <div class="creators_metric-box">
                                       <div class="creators_metric-value-text">312 Posts</div>
                                       <div class="creators_metric-label">5 Night Stay</div>
                                    </div>
                                 </div>
                        ...
                        <!-- Portfolio Card 5 - Tesla Motors -->
                        <div class="col-12 col-sm-6 col-xl-3 creators_card-col">
                           <div class="creators_card">

                              <div class="creators_image-wrapper">
                                 <img src="https://ik.imagekit.io/kaveeshkapoor/acollabmedia/promotion%20(6).png?updatedAt=1762243503392"
                                    alt="Tesla" class="creators_image">
                                 <div class="creators_gradient-overlay"></div>
                              </div>
                              ...
                              <div class="creators_content">
                                 ...
                                 <div class="creators_header">
                                    <h3 class="creators_title">Tesla Motors</h3>
                                 </div>
                                 ...
                                 <div class="creators_metrics">
                                    <div class="creators_metric-box creators_metric-flex">
                                       <div class="creators_metric-value">
                                          <span class="creators_icon-star">★</span>
                                          <span class="creators_number">4.1M</span>
                                       </div>
                                       <div class="creators_metric-label">Impressions</div>
                                    </div>
                                    <div class="creators_metric-box">
                                       <div class="creators_metric-value-text">278 Posts</div>
                                       <div class="creators_metric-label">Premium</div>
                                    </div>
                                 </div>
                        ...
                        <!-- Portfolio Card 6 - Starbucks -->
                        <div class="col-12 col-sm-6 col-xl-3 creators_card-col">
                           <div class="creators_card">

                              <div class="creators_image-wrapper">
                                 <img src="https://ik.imagekit.io/kaveeshkapoor/acollabmedia/promotion%20(2).png?updatedAt=17622435030131"
                                    alt="Starbucks" class="creators_image">
                                 <div class="creators_gradient-overlay"></div>
                              </div>
                              ...
                              <div class="creators_content">
                                 ...
                                 <div class="creators_header">
                                    <h3 class="creators_title">Starbucks</h3>
                                 </div>
                                 ...
                                 <div class="creators_metrics">
                                    <div class="creators_metric-box creators_metric-flex">
                                       <div class="creators_metric-value">
                                          <span class="creators_icon-star">★</span>
                                          <span class="creators_number">2.7M</span>
                                       </div>
                                       <div class="creators_metric-label">Impressions</div>
                                    </div>
                                    <div class="creators_metric-box">
                                       <div class="creators_metric-value-text">201 Posts</div>
                                       <div class="creators_metric-label">Cozy Stay</div>
                                    </div>
                        ...
                        <!-- Portfolio Card 7 - Amazon India -->
                        <div class="col-12 col-sm-6 col-xl-3 creators_card-col">
                           <div class="creators_card">

                              <div class="creators_image-wrapper">
                                 <img src="https://ik.imagekit.io/kaveeshkapoor/acollabmedia/promotion%20(5).png?updatedAt=1762243503169"
                                    alt="Amazon" class="creators_image">
                                 <div class="creators_gradient-overlay"></div>
                              </div>
                              ...
                              <div class="creators_content">
                                 ...
                                 <div class="creators_header">
                                    <h3 class="creators_title">Amazon India</h3>
                                 </div>
                                 ...
                                 <div class="creators_metrics">
                                    <div class="creators_metric-box creators_metric-flex">
                                       <div class="creators_metric-value">
                                          <span class="creators_icon-star">★</span>
                                          <span class="creators_number">6.3M</span>
                                       </div>
                                       <div class="creators_metric-label">Impressions</div>
                                    </div>
                                    <div class="creators_metric-box">
                                       <div class="creators_metric-value-text">445 Posts</div>
                                       <div class="creators_metric-label">Top Rated</div>
                                    </div>
                                 </div>
                        ...
                        <!-- Portfolio Card 8 - Adidas -->
                        <div class="col-12 col-sm-6 col-xl-3 creators_card-col">
                           <div class="creators_card">

                              <div class="creators_image-wrapper">
                                 <img src="https://ik.imagekit.io/kaveeshkapoor/acollabmedia/promotion%20(7).png?updatedAt=1762243503311"
                                    alt="Adidas" class="creators_image">
                                 <div class="creators_gradient-overlay"></div>
                              </div>
                              ...
                              <div class="creators_content">
                                 ...
                                 <div class="creators_header">
                                    <h3 class="creators_title">Adidas</h3>
                                 </div>
                                 ...
                                 <div class="creators_metrics">
                                    <div class="creators_metric-box creators_metric-flex">
                                       <div class="creators_metric-value">
                                          <span class="creators_icon-star">★</span>
                                          <span class="creators_number">3.4M</span>
                                       </div>
                                       <div class="creators_metric-label">Impressions</div>
                                    </div>
                                    <div class="creators_metric-box">
                                       <div class="creators_metric-value-text">267 Posts</div>
                                       <div class="creators_metric-label">Trending</div>
                                    </div>
                                 </div>
                     ...
                     <div class="row gaper">
                        <div class="col-12 col-lg-5">
                           <div class="offer__content section__content">
                              ...
                              <h2 class="title title-anim">
                                 Powering Your Brand with Creative Content & Promotion
                              </h2>
                              <div class="paragraph">
                                 <p>
                                    We create engaging, impactful, and data-driven content to boost
                                    your online visibility. From social media to video ads, our
                                    creative experts make sure your brand stands out across all
                                    platforms.
                                 </p>
                              </div>
                              <div class="section__content-cta">
                           ...
                           <div class="offer__cta">
                              ...
                              <div class="offer__cta-single fade-top">
                                 ...
                                 <div class="offer-thumb-hover d-none d-md-block"
                                    data-background="https://img.freepik.com/free-photo/social-media-marketing-concept-with-smartphone_23-2150179635.jpg">
                                 </div>
                              </div>

                              <!-- 02: Product Ad Promotion -->
                              <div class="offer__cta-single fade-top">
                                 <span class="sub-title">
                                    02
                                    <i class="fa-solid fa-arrow-right"></i>
                                 ...
                                 <div class="offer-thumb-hover d-none d-md-block"
                                    data-background="https://img.freepik.com/free-photo/woman-filming-product-video_23-2149193108.jpg">
                                 </div>
                              </div>

                              <!-- 03: Video Content Creation -->
                              <div class="offer__cta-single fade-top">
                                 <span class="sub-title">
                                    03
                                    <i class="fa-solid fa-arrow-right"></i>
                                 ...
                                 <div class="offer-thumb-hover d-none d-md-block"
                                    data-background="https://img.freepik.com/free-photo/young-female-vlogger-recording-studio_23-2148838792.jpg">
                                 </div>
                              </div>
                              ...
                              <!-- <div class="offer__cta-single fade-top">
                                 ...
                                 <div class="offer-thumb-hover d-none d-md-block"
                                    data-background="https://img.freepik.com/free-photo/influencer-streaming-online_23-2149254460.jpg">
                                 </div>
                              </div> -->

                              <!-- 05: SEO & Blog Promotion -->
                              <!-- <div class="offer__cta-single fade-top">
                                 <span class="sub-title">
                                    05
                                    <i class="fa-solid fa-arrow-right"></i>
                                 ...
                                 <div class="offer-thumb-hover d-none d-md-block"
                                    data-background="https://img.freepik.com/free-photo/seo-analytics-graphs_23-2148819101.jpg">
                                 </div>
                              </div> -->
               ...
               <section class="section testimonial pt-0 position-relative">
                                    ...
                                    <div class="col-12 col-lg-4 col-xxl-4">
                                       <div class="thumb">
                                          ...
                                          <svg xmlns="http://www.w3.org/2000/svg" width="44" height="322"
                                             ...
                                             <path d="M43 0V152L2 193H43V322" stroke="#D9D9D9" />
                                          </svg>
                                       </div>
                                    </div>
                  ...
                  <div class="pin-spacer" style="order: 0; place-self: auto; grid-area: auto; z-index: auto; float: none; flex-shrink: 1; display: flex; margin: 0px -15px; inset: 0px; position: relative; flex-basis: auto; overflow: visible; box-sizing: border-box; width: 1530px; height: 2580px; padding: 0px 0px 1530px;"><section class="section project-sl" style="translate: none; rotate: none; scale: none; inset: 0px auto auto 0px; margin: 0px; max-width: 1500px; width: 1500px; max-height: 1050px; height: 1050px; padding: 60px 0px; transform: translate(0px, 0px);">
                  <div class="project-sl__single" style="translate: none; rotate: none; scale: none; transform: translate(0px, 0px);">
                     <div class="thumb">
                        <a href="project-single.html">
                           <img src="https://ik.imagekit.io/kaveeshkapoor/acollabmedia/promotion%20(4).png?updatedAt=1762243504313" alt="Image">
                        </a>
                     </div>
                     <div class="content">
                        <h2>
                  ...
                  <div class="project-sl__single" style="translate: none; rotate: none; scale: none; transform: translate(0px, 0px);">
                     <div class="thumb">
                        <a href="project-single.html">
                           <img src="https://ik.imagekit.io/kaveeshkapoor/acollabmedia/promotion%20(7).png?updatedAt=1762243503311" alt="Image">
                        </a>
                     </div>
                     <div class="content">
                        <h2>
                  ...
                  <div class="project-sl__single" style="translate: none; rotate: none; scale: none; transform: translate(0px, 0px);">
                     <div class="thumb">
                        <a href="project-single.html">
                           <img src="https://ik.imagekit.io/kaveeshkapoor/acollabmedia/promotion%20(7).png?updatedAt=1762243503311g" alt="Image">
                        </a>
                     </div>
                     <div class="content">
                        <h2>
                  ...
                  <div class="project-sl__single" style="translate: none; rotate: none; scale: none; transform: translate(0px, 0px);">
                     <div class="thumb">
                        <a href="project-single.html">
                           <img src="https://ik.imagekit.io/kaveeshkapoor/acollabmedia/promotion%20(7).png?updatedAt=1762243503311https://ik.imagekit.io/kaveeshkapoor/acollabmedia/promotion%20(7).png?updatedAt=1762243503311" alt="Image">
                        </a>
                     </div>
                     <div class="content">
                        <h2>
